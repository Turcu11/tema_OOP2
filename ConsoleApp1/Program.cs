...
namespace ConsoleApp1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Universitatea_Emanuel_din_Oradea.Students = new Student[] 
            { 
            new Student("Turcu", "Iosif", new DateTime(2001, 08, 11), "001"),
            ...
            Console.WriteLine(Universitatea_Emanuel_din_Oradea.Index("001"));
        }
    }
}
